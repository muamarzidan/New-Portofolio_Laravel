        ...
        <div class="flex flex-wrap lg:justify-between -mx-4">
            <div class="w-full lg:w-1/2 xl:w-6/12 px">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <p class="text-base text-body-color dark:text-gray-200 loading-relaxed mb-9">  
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, quod.
                    </p>
                    <div class="flex-mb-8 max-w-[370px] w-full">
                        <div class="max-w-[60px] sm:max-w-[70px] flex items-center justify-center mr-6 overflow-hidden bg-primary bg opacity-5 text-primary dark:text-gray-300 rounded">
                            <svg
                            width="28"
                            height="19"
                            viewBox="0 0 28 19"
