            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    <h1 class="text-dark dark:text-gray-200 font-bold text-4xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6">
                        My name is Zidan <br/>
                        Iam <span class="rounded-md text-amber-600">Muziro</span>
                    </h1>
                    <p>
                        Iam a junior to be web developer. <br/>
                        Iam a student of software engineering at SMK TELKOM PURWOKERTO.
                        <a target="_blank" href="" class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary">
                            Youtube Channel
                        </a>
                        </br>
                    </p>
