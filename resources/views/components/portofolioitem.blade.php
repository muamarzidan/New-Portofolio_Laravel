    ...
    <div class="relative mb-8">
        <a href="{{$github}}" target="_blank">
            <div class="rounded-lg overflow-hidden ease-in duration-300 hover:scale-105">
                <img src="{{ $image }}" alt="portofolio" class="w-240 h-[240px] object-cover mx-auto" target="_blank">
            </div>
        </a>
        <div class="text-center bg-white dark:bg-slate-800 relative z-10 py-9 px-3 rounded-lg shadow-lg mx-7 -mt-4 h-[220px]">
